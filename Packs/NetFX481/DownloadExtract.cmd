...
echo.-------------------------------------------------------------------------------
echo.正在下载 .NET Framework 4.8.1 包文件
echo.-------------------------------------------------------------------------------
echo.
...
set "DownloadURI=https://download.microsoft.com/download/f/d/e/684da43a-447d-4ac8-817f-c7c3e9b4e5bb/Windows10.0-KB5011048-arm64.cab"
...
set "DownloadURI=https://download.microsoft.com/download/f/d/e/684da43a-447d-4ac8-817f-c7c3e9b4e5bb/Windows10.0-KB5011048-x64.cab"
call :DownloadFile !DownloadURI!, !DownloadFileName!

set "DownloadFileName=Microsoft-Windows-NetFX481-Package~31bf3856ad364e35~x86.cab"
set "DownloadURI=https://download.microsoft.com/download/f/d/e/684da43a-447d-4ac8-817f-c7c3e9b4e5bb/Windows10.0-KB5011048-x86.cab"
call :DownloadFile !DownloadURI!, !DownloadFileName!
...
::-------------------------------------------------------------------------------------------
:: 下载 EXE 文件并解压所有 CAB 文件模组
:: 输入参数 [ %~1 ：下载 URI、%~2 ：下载文件名称 ]
::-------------------------------------------------------------------------------------------
...
::-------------------------------------------------------------------------------------------
:: 从 Web 下载某些文件模组
:: 输入参数 [ %~1 ：下载 URI、%~2 ：包文件名称 ]
::-------------------------------------------------------------------------------------------
:DownloadFile
if not exist "%~2" (
	@start "正在下载 %~2 文件……" /wait /B PowerShell.exe -Command Start-BitsTransfer -Source "%~1" -Destination "%~2"
) else (
	echo.
	echo %~2 文件已存在。
)
